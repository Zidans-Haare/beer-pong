...
export function LiveTicker({ tournamentId }: { tournamentId: string }) {
    ...
    return (
        <div className="glass-card p-4 flex flex-col mt-6 transition-all duration-300">
            <div
                className="flex justify-between items-center cursor-pointer"
                onClick={() => setIsCollapsed(!isCollapsed)}
            >
                <h3 className="text-xl font-bold font-outfit bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400 select-none">
            ...
            {!isCollapsed && (
                <div className="overflow-y-auto h-[300px] mt-4 pr-2 space-y-3 custom-scrollbar">
