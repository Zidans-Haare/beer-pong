...
function FormulaRow({ label, formula, result, highlight }: { label: string; formula: string; result: string; highlight?: boolean }) {
    return (
        <div style={{
            display: 'grid',
            ...
            <span style={{ fontSize: '0.75rem', fontWeight: highlight ? 700 : 500, color: highlight ? 'var(--color-primary)' : 'var(--color-text-subtle)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                {label}
            </span>
            <span style={{ fontSize: '0.82rem', fontFamily: 'monospace', color: 'var(--color-text-dim)' }}>
                {formula}
            </span>
            <span style={{ fontSize: '0.85rem', fontWeight: 700, color: highlight ? 'var(--color-primary)' : 'var(--color-text)', textAlign: 'right', whiteSpace: 'nowrap' }}>
                = {result}
            </span>
        </div>
    );
